...
<html>
	...
	<body>
		...
		<table>
			...
			<tr>
				<th>ID</th>
				<td class="input"><input type="text" name="user_id" style="border: 0;" maxlength="100"></td>
			</tr>
			<tr>
				<th>PASSWORD</th>
				<td class="input"><input type="password" name="user_pw" style="border: 0;" maxlength="100"></td>
			</tr>			
		</table>
		<p>
